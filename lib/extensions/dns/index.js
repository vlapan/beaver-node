    ...
    generate(callback) {
        ...
        // LOCAL VIEWS
        {
            ...
            for (const lan of lans) {
                ...
                const viewConfPath = `${zonesPath}/${viewKey}.conf`;
                ...
                fs.writeFileSync(viewConfPath, viewResult, 'UTF-8');

                includeConf += `include "master/beaver/${viewKey}.conf";\n`;
            }
        }
        ...
        fs.writeFileSync(`${zonesPath}/default.conf`, includeConf, 'UTF-8');
