...
module.exports = {
    async generate(o) {
        ...
        const prefixMaster = options?.prefix?.master || o.argv.dnsPath;
        const prefixSlave = options?.prefix?.slave || o.argv.dnsSlavePath;
        ...
        // GLOBAL VIEW
        {
            ...
            viewResult += '    };\n';
            viewResult += '    include "/usr/local/etc/namedb/default.zones";\n';
            viewResult += `    include "/usr/local/etc/namedb/${prefixMaster}/acme.conf";\n`;
            viewResult += '\n';
