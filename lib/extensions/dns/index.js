...
module.exports = {
    async generate(o) {
            ...
            for (const lan of lans) {
                ...
                for (const domain of viewSource.list) {
                    ...
                    if (domain.mode === 'static') {
                        domain.zonePath = `primary/beaver/${viewKey}/${domain.keyClean}.dns`;
                        ...
                        domain.zonePath = `secondary/beaver-${viewKey}-${domain.keyClean}.dns`;
        ...
        // GLOBAL VIEW
        {
            ...
            viewResult += '    };\n';
            viewResult += '    include "/usr/local/etc/namedb/default.zones";\n';
            viewResult += '    include "/usr/local/etc/namedb/primary/beaver/acme.conf";\n';
            viewResult += '\n';
