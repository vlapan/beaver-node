...
module.exports = {
    generate(callback) {
        ...
        output += '${fw} add 608 nat 1 ip from 10.0.0.0/8 to any out\n';
        output += '${fw} add 608 nat 1 ip from 172.16.0.0/12 to any out\n';
        output += '${fw} add 608 nat 1 ip from 192.168.0.0/16 to any out\n';
