...
const drawTemplate = (o) => file`
    ...
    : | $fw /dev/stdin <<- EOF
        ...
        ${o.httpPort.map((port, i) => `add ${21010 + i} set 2 allow ip4 from me to not me  src-port ${port} out // http out`).join(' \n        ')}
        ${o.httpPort.map((port, i) => `add ${41010 + i} set 2 allow ip6 from me to not me6 src-port ${port} out // http out`).join(' \n        ')}
        ...
        add 21032 set 2 allow ip4 from me to not me  src-port ${o.tincPort} out // tinc out
        add 41032 set 2 allow ip6 from me to not me6 src-port ${o.tincPort} out // tinc out
        add 21033 set 2 allow ip4 from me to not me  src-port ${o.beaverPort} out // beaver-api out
        add 41033 set 2 allow ip6 from me to not me6 src-port ${o.beaverPort} out // beaver-api out
