    ...
    : | $fw /dev/stdin <<- EOF
        ...
        ${
            (o.httpClosed ? [
                ...
                `add 504 set 2 deny ip from any to me dst-port ${o.httpPort} in // http: deny others`,
            ] : [
                `add 504 set 2 allow ip from any to me dst-port ${o.httpPort} in // http: allow all`,
            ]).join('\n        ')
        }
