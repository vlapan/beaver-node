...
const drawTemplate = (o) => file`
    ...
    : | $fw /dev/stdin <<- EOF
        ...
        add 515 set 2 skipto 613 ip from any to 167.233.6.242 flow table(service-wan)${o.iface ? ` recv ${o.iface}` : ''}


        add 518 set 2 nat ${o.natDynamicId} ip from any to ${o.externalIp} in${o.iface ? ` recv ${o.iface}` : ''} // natDynamic: incoming nat
        ...
        add 608 set 2 nat ${o.natDynamicId} ip from 10.0.0.0/8 to any out${o.iface ? ` xmit ${o.iface}` : ''} // natDynamic: outgoing nat
        add 608 set 2 nat ${o.natDynamicId} ip from 172.16.0.0/12 to any out${o.iface ? ` xmit ${o.iface}` : ''} // natDynamic: outgoing nat
        add 608 set 2 nat ${o.natDynamicId} ip from 192.168.0.0/16 to any out${o.iface ? ` xmit ${o.iface}` : ''} // natDynamic: outgoing nat

        add 611 set 2 skipto 620 ip from any to any

        add 614 set 2 nat ${o.natServiceId} ip from any to ${o.externalIp} in${o.iface ? ` recv ${o.iface}` : ''} // natService: incoming nat
        ...
        add 615 set 2 nat ${o.natServiceId} ip from 10.0.0.0/8 to any out${o.iface ? ` xmit ${o.iface}` : ''} // natService: outgoing nat
        add 615 set 2 nat ${o.natServiceId} ip from 172.16.0.0/12 to any out${o.iface ? ` xmit ${o.iface}` : ''} // natService: outgoing nat
        add 615 set 2 nat ${o.natServiceId} ip from 192.168.0.0/16 to any out${o.iface ? ` xmit ${o.iface}` : ''} // natService: outgoing nat
