...
module.exports = {
    generate(callback) {
        ...
        output += '${fw} add 508 allow tcp from me to not me out\n';
        output += '${fw} add 508 allow udp from me to not me out\n';
        output += '${fw} add 508 allow tcp6 from me to not me out\n';
        output += '${fw} add 508 allow udp6 from me to not me out\n';
        output += '${fw} add 508 allow ipv6 from me to any out\n';
        output += '${fw} add 508 allow ipv6 from any to me in\n';
