...
const drawTemplate = (o) => file`
    ...
    : | $fw /dev/stdin <<- EOF
        ...
        add 515 set 2 skipto 521 ip from any to ${o.externalIp} flow table(service-wan)
        ...
        add 521 set 2 nat ${o.natServiceId} tag 7 ip from any to ${o.externalIp} in // incoming nat, service
