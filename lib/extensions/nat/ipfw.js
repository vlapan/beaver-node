...
const drawTemplate = (o) => file`
    ...
    : | $fw /dev/stdin <<- EOF
        ...
        add 523 set 2 skipto 600 ip from 10.0.0.0/8 to 10.0.0.0/8 in // local traffic
        add 523 set 2 skipto 600 ip from 172.16.0.0/12 to 172.16.0.0/12 in // local traffic
        add 523 set 2 skipto 600 ip from 192.168.0.0/16 to 192.168.0.0/16 in // local traffic
