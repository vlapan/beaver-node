...
const tinc = {
    async generate(o) {
        ...
        if (typeof config._hostConfig.tap !== 'object') {
        ...
        for (const [net, hosts] of Object.entries(nets)) {
            ...
            promisesHosts.push(Promise.all([
                ...
                tinc.generateTincConf(net, netPath, hosts, options),
            ...
            promisesHosts.push(Promise.all([
                ...
                tinc.generateRoutesScript(netPath, config._hostConfig.tap),
    ...
    generateTincConf(net, netPath, hosts, options) {
        let output = '';
