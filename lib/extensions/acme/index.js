...
const { keyInArray } = require('../../utils');
        ...
        for (const route of o.config.parser.targetListWeb) {
            ...
            if (preset && preset.acmeAny) {
                ...
                if (preset.acmeDns) {
                    ...
                    const domainsSource = masterView.buildDnsView(null).map;
                    const masterDomains = Object.keys(domainsSource);
                    ...
                    if (preset.master === o.config._hostname) {
                        ...
                        for (const zoneKey of zones) {
                            ...
                            if (!keyInArray(zone, account.masterDomains || [])) {
