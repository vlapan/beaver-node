            ...
            (function() {
                ...
                if ("number" == typeof $obj.length) {
                    for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
                        var host = $obj[$index];
                        buf.push('<div class="host"><label><input type="checkbox" name="forward"' + jade.attr("value", host.key, true, false) + jade.attr("disabled", host.self, true, false) + jade.attr("checked", host.self, true, false) + "/><span>" + (null == (jade_interp = host.key) ? "" : jade_interp) + '</span></label><ul style="margin-top:0;list-style-type:none;padding-left:14px;">');
                        if (host.self) {
                            buf.push('<li><small ip="127.0.0.1" class="address"><input type="radio"' + jade.attr("name", host.key, true, false) + ' disabled="disabled" checked="checked" style="width:1em;vertical-align:middle;"/>' + (null == (jade_interp = "127.0.0.1") ? "" : jade_interp) + "</small>" + (null == (jade_interp = "&nbsp;") ? "" : jade_interp) + '<small style="float:right;margin-right:5px;color:grey;">' + (null == (jade_interp = "local") ? "" : jade_interp) + "</small></li>");
                        } else {
                            (function() {
