            ...
            (function() {
                ...
                if ("number" == typeof $obj.length) {
                    for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
                        var host = $obj[$index];
                        buf.push('<div class="host"><label><input type="checkbox" name="forward"' + jade.attr("value", host.key, true, false) + jade.attr("disabled", host.self, true, false) + ' checked="checked"/><span' + jade.attr("ip", host.wan && host.wan.ip, true, false) + ">" + (null == (jade_interp = host.key) ? "" : jade_interp) + "</span></label></div> ");
                    }
                } else {
                    var $l = 0;
