...
document.addEventListener('DOMContentLoaded', function (event) {
    ...
    explainButton.onclick = function (e) {
        ...
        container.children[0].style.right = '5px';
        container.children[1].style.position = 'sticky';
        container.children[1].style.display = 'inline-block';
        container.children[1].style.float = 'right';
        container.children[1].style.right = '0';
        outterDiv.append(container);
        document.body.append(outterDiv);
        return false;
    };
