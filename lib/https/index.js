...
const debugAuth = debugWeb.extend('auth');
...
const { bobotAuthPath, signJWT, verifyJWT, setJWTCookie, getBobotJWTCookie } = require('../bobot');
    ...
    const authenticationMethods = {
        passwd: async () => {
            try {
                ...
                app.use(passwdAuth.bind(undefined, unixcrypt));
            } catch (e) {
                return e;
            }
        },
        pam: () => {
            try {
                ...
                app.use(pamAuth.bind(undefined, pam));
            } catch (e) {
                return e;
            }
        },
        pam_helper: async () => {
            try {
                ...
                app.use(pamHelperAuth.bind(undefined, pamHelperPath));
            } catch (e) {
                return e;
            }
        },
