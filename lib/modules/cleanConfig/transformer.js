...
class CleanConfig extends AbstractTransformer {
    ...
    transform() {
        ...
        return Promise.all([
            ...
            pathAsJSON(path.join(this.o.argv.home, this.fileName), false).then((v) => typeof v === 'object' && (this.changes = diff(structure.reductPKI(v), structure.reductPKI(this.data)))),
        ]);
    }
