...
: | $fw /dev/stdin <<- EOF
    ...
    add 515 set 2 skipto 613 ip from any to 167.233.6.242 flow table(service-wan)


    add 518 set 2 nat 2 ip from any to 10.20.20.20 in // natDynamic: incoming nat
    ...
    add 614 set 2 nat 1 ip from any to 10.20.20.20 in // natService: incoming nat
