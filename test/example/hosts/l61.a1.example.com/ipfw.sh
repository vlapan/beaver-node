...
${fw} nat 1 config if wan.4022 unreg_only \
    ...
    redirect_port tcp 127.0.0.1:22 1022 $(true || comment type-unix-a1-l61.a1.example.com) \
    ...
    redirect_port tcp 192.168.64.27:22 2022 $(true || comment type-unix-a1-l62.a1.example.com) \
