...
${fw} nat 1 config if wan.4022 unreg_only \
    ...
    redirect_port udp 127.0.0.1:655 1003 $(true || comment beaver-tinc-a1-l61.a1.example.com) \
    redirect_port tcp 127.0.0.1:53 1053 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port udp 127.0.0.1:53 1053 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port tcp 127.0.0.1:82 1082 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port udp 127.0.0.1:82 1082 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port tcp 127.0.0.1:27 1022 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port tcp 127.0.0.1:80 1080 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port tcp 127.0.0.1:443 1443 $(true || comment type-unix-a1-l61.a1.example.com) \
    redirect_port tcp 192.168.64.27:1001 2002 $(true || comment beaver-web-a1-l62.a1.example.com) \
    redirect_port tcp 192.168.64.27:655 2003 $(true || comment beaver-tinc-a1-l62.a1.example.com) \
    redirect_port udp 192.168.64.27:655 2003 $(true || comment beaver-tinc-a1-l62.a1.example.com) \
    redirect_port tcp 192.168.64.27:53 2053 $(true || comment type-unix-a1-l62.a1.example.com) \
    redirect_port udp 192.168.64.27:53 2053 $(true || comment type-unix-a1-l62.a1.example.com) \
    redirect_port tcp 192.168.64.27:82 2082 $(true || comment type-unix-a1-l62.a1.example.com) \
    redirect_port udp 192.168.64.27:82 2082 $(true || comment type-unix-a1-l62.a1.example.com) \
    redirect_port tcp 192.168.64.27:27 2022 $(true || comment type-unix-a1-l62.a1.example.com) \
    redirect_port tcp 192.168.64.27:80 2080 $(true || comment type-unix-a1-l62.a1.example.com) \
    redirect_port tcp 192.168.64.27:443 2443 $(true || comment type-unix-a1-l62.a1.example.com) \
