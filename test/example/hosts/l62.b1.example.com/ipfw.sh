...
: | $fw /dev/stdin <<- EOF
    ...
    set 2 table tinc-tap-l6-hosts-remote add 172.16.5.2 10.254.3.1 	 #   net: l61.c1.example.com


    set 2 table tinc-tap-l6-hosts-local create or-flush
    set 2 table tinc-tap-l6-hosts-local add 172.16.4.2 			 #   net: l62.b1.example.com
