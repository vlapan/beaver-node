...
: | $fw /dev/stdin <<- EOF
    ...
    add 515 set 2 skipto 521 ip from any to 10.20.21.20 flow table(service-wan)
    ...
    add 521 set 2 nat 1 tag 7 ip from any to 10.20.21.20 in // incoming nat, service
